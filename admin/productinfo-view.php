                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                ...
                                <input type="text" class="form-control" value="<?php echo $prod['Presentación']; ?>" required name="prod-model">
                              </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                ...
                                <select class="form-control" name="prod-codigoP">
                                    <?php
                                        ...
                                        while($prov=mysqli_fetch_array($proveedor, MYSQLI_ASSOC)){
                                        	if($prod['RIFProveedor']==$prov['RIFProveedor']){
                                        		echo '<option selected="" value="'.$prov['RIFProveedor'].'">'.$prov['NombreProveedor'].' (Actual)</option>';
                                        	}else{
                                            	echo '<option value="'.$prov['RIFProveedor'].'">'.$prov['NombreProveedor'].'</option>';	
                                        	}
                                        }
                                    ?>
                                </select>
