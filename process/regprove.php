...
$emailProve=consultasSQL::clean_string($_POST['prove-email']);
...
if(mysqli_num_rows($verificar)<=0){
    ...
    echo '<script>swal("ERROR", "El número de RIF/CEDULA que ha ingresado ya se encuentra registrado en el sistema, por favor ingrese otro número de RIF o CEDULA", "error");</script>';
}
