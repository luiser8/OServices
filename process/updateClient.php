<?php
	...
	$RIF=consultasSQL::clean_string($_POST['clien-rif']);
	...
	if($oldPass!="" && $newPass!="" && $newPass2!=""){
		if($newPass!=$newPass2){
			...
			if(mysqli_num_rows($CheckLog)==1){
				$newPass=md5($newPass);
				$campos="Nombre='$user',NombreCompleto='$Nombre',Clave='$newPass',Direccion='$Direccion',Telefono='$Telefono',Email='$Email'";
			}else{
		...
		$campos="Nombre='$user',NombreCompleto='$Nombre',Direccion='$Direccion',Telefono='$Telefono',Email='$Email'";
	}
