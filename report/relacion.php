...
$pdf->Cell( 20, 5, utf8_decode("N° Pedido"), 1,'j','C');
$pdf->Cell( 22, 5, "Fecha", 1,'j','C');
$pdf->Cell( 20, 5,utf8_decode('Rif'), 1,'j','C');
$pdf->Cell( 28, 5, "Cliente", 1,'j','C');
$pdf->Cell( 30, 5, utf8_decode("N°. Deposito"), 1,'j','C');
$pdf->Cell( 26, 5, "Cuenta", 1,'j','C');
$pdf->Cell( 26, 5, "Envio", 1,'j','C');
...
while($fila1 = mysqli_fetch_array($sDet, MYSQLI_ASSOC)){
    ...
    //Con formatos
    $pdf->Ln();
    $pdf->Cell (20,8,$fila1['NumPedido'],1,0,'C');
    $pdf->Cell (22,8,$fila1['Fecha'],1,0,'C');
    $pdf->Cell (20,8,$fila1['RIF'],1,0,'C');
    $pdf->Cell (28,8,utf8_decode($fila1['NombreCompleto']),1,0,'C');
    $pdf->Cell (30,8,$fila1['NumeroDeposito'],1,0,'C');
    $pdf->Cell (26,8,$fila1['NumeroCuenta'],1,0,'C');
    $pdf->Cell (26,8,$fila1['TipoEnvio'],1,0,'C');
