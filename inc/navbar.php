...
<nav id="navbar-auto-hidden">
        <div class="row hidden-xs">
            ...
            <!-- <p class="text-navbar tittles-pages-logo">INVERSORA ORIENTE SERVICES C.A.</p> -->
            </div>
            <div class="col-xs-8">
...
<!-- Mobile menu navbar -->
    ...
    <div id="mobile-menu-list" class="hidden-sm hidden-md hidden-lg">
        <br>
        <h3 class="text-center tittles-pages-logo"></h3>
        ...
        <ul class="list-unstyled text-center">
            ...
            <?php 
                if(!$_SESSION['nombreAdmin']==""){
                    ...
                    <li><a href="#" class="glyphicon glyphicon-cog userConBtn" data-code="'.$_SESSION['UserRIF'].'"> Configuraciones</a></li>
                    ';
                }else{
